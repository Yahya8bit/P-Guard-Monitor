...
export function formatDateTime(iso: string, lang: 'fr' | 'en' = 'fr'): string {
...
// Relative time vs a reference instant (the frozen mock NOW).
export function relativeFromNow(iso: string, nowMs: number, lang: 'fr' | 'en' = 'fr'): string {
